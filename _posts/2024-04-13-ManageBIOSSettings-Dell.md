...
If you want to be able to fetch all BIOS passwords stored in your tenant, you will also need the following: `DeviceManagementManagedDevices.PrivilegedOperations.All`
