...
To start configuring Autopatch, you need an Entra group for device onboarding. This can be static or dynamic. Navigate to Tenant Administration > Autopatch groups and click "New autopatch group."
